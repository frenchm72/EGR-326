/***********************************************************************************************************
  Title:        EGR 326 Lab 7
  Filename:     Part_I.c, wstep.h, wstep.c
  Author(s):    Mathew J. Yerian-French
  Date:         10/16/2020
  Instructor:   Professor Brian Krug
  Description:  Part I of Lab 7
  Note:         Half step mode was used for a smoother action. It is *2 in the function. This can be
  commented out for true half step. The resolution has a range of 0-645 when in halfstep mode.
************************************************************************************************************
WIRING FOR MSP432
Push Button   : In  - P3.6
